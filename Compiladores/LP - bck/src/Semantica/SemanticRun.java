...
public class SemanticRun {
	...
	private SymbolTable simbolos;
	private int foundSemanticError;
	
	public SymbolTable getSimbolos() {
		return simbolos;
	}

	public void setSimbolos(SymbolTable simbolos) {
	...
	public void func_declCheck(SimpleNode alvo) throws SemanticException {
		...
		if(simbolos.find(nome_proc, "Global") == 0) {
			if(nome_proc.equals("main"))
				simbolos.add(new InsertTable(nome_proc, "keyword", "proc", retorno, "None", "Global"));
			else
				simbolos.add(new InsertTable(nome_proc, "id", "proc", retorno, "None", "Global"));
		}
		else
	...
	private void var_listCheck(SimpleNode filho) throws SemanticException {
		...
		if(simbolos.find(nome, "Local") == 0) {
			simbolos.add(new InsertTable(nome, "id", "var", tipo, "0", "Local"));
		}
		else 
	...
	public void param_listCheck(SimpleNode param){
		...
		simbolos.add(new InsertTable(nome1, "id", "par", tipo1, "0", "Local"));
		if(nome2 != null) simbolos.add(new InsertTable(nome2, "id", "par", tipo2, "0", "Local"));
	}
}